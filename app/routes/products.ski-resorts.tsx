...
const SCHEMATIC_CATEGORY = 'ski_resorts';
...
async function loadCriticalData({
  ...
  // Extract schematic category from productType (format: schematic.ski_resort)
  const schematicCategory = product.productType?.startsWith('schematics.')
  ...
  const envDefault = context.env.SKI_RESORT_DEFAULT_SCHEMATIC_ID ?? null;
