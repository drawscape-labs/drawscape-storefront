...
const SCHEMATIC_CATEGORY = 'aircraft';
...
async function loadCriticalData({
  ...
  // Extract schematic category from productType (format: schematic.aircraft)
  ...
  const envDefault = context.env.AIRCRAFT_DEFAULT_SCHEMATIC_ID ?? null;
