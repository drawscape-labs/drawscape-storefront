        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Turn any Sailboat into frame-worthy art
            </h1>
            <p className="mt-4 text-xl text-gray-500">
              Create custom sailboat art, and then watch it drawn with a plotting machine.
            </p>
                ...
                <div className="flex items-center space-x-6 lg:space-x-8">
                  <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                      <Image
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/sailboat_upclose.jpg?v=1752885392"
                  ...
                  <div className="h-64 w-44 overflow-hidden rounded-lg">
                      <Image
                        alt="Holding a framed sailboat  artwork"
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/IMG_7238.jpg?v=1747762413"
                        className="size-full object-cover"
                        sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw"
                        width={176}
                        height={256}
                    ...
                    <div className="h-64 w-44 overflow-hidden rounded-lg">
                      <Image
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/DSC_0005_2.jpg?v=1747759978"
                        className="size-full object-cover"
                        sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw"
                        width={176}
                        height={256}
                    ...
                    <div className="h-64 w-44 overflow-hidden rounded-lg">
                      <Image
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/shipblue.jpg?v=1752885392"
                        className="size-full object-cover"
                        sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw"
                        width={176}
                        height={256}
                  ...
                  <div className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div className="h-64 w-44 overflow-hidden rounded-lg">
                      <Image
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/DSC_0004_1.jpg?v=1758996052"
                        className="size-full object-cover"
                        sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw"
                        width={176}
                        height={256}
                    ...
                    <div className="h-64 w-44 overflow-hidden rounded-lg">
                      <Image
                        src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/IMG_7340.jpg?v=1752885392"
                        className="size-full object-cover"
                        sizes="(min-width: 1024px) 25vw, (min-width: 768px) 50vw, 100vw"
                        width={176}
                        height={256}
            ...
            <div className="aspect-3/2 w-full rounded-lg bg-gray-100 overflow-hidden">
              <Video
                data={{
                  ...
                  sources: [
                    {
                      url: 'https://cdn.shopify.com/videos/c/o/v/cd4377e13d444e6e95ff9f54fb01568e.mov',
                      mimeType: 'video/mp4',
                      height: 800,
                      width: 1200,
                    }
  ...
  return (
    <div className="relative bg-gray-800 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
      <div className="absolute inset-0 overflow-hidden">
        <Image
          alt="Sailboat blueprint art full-width background"
          src="https://cdn.shopify.com/s/files/1/0905/0138/2438/files/DSC_0027.jpg?v=1747759978"
          className="size-full object-cover"
        />
      </div>
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
        <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Perfect Gift For Sailors!</h2>
        <p className="mt-3 text-xl text-white">
          Give the sailor or nautical enthusiast in your life a truly one-of-a-kind gift.
        </p>
        <Link
          to="/products/sailboats"
