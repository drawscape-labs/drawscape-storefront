...
const SCHEMATIC_CATEGORY = 'trails';
...
async function loadCriticalData({
  ...
  // Extract schematic category from productType (format: schematic.trails)
  ...
  const envDefault = context.env.TRAIL_DEFAULT_SCHEMATIC_ID ?? null;
