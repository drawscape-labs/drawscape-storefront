...
const SCHEMATIC_CATEGORY = 'airport_traffic';
...
async function loadCriticalData({
  ...
  // Extract schematic category from productType (format: schematic.airport_traffic)
  ...
  const envDefault = context.env.AIRPORT_TRAFFIC_DEFAULT_SCHEMATIC_ID ?? null;
